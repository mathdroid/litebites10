...
- ✅ Functional vs Class components, Props vs State, connecting to API

- ⛔ HTML/CSS/JS Tutorial (rewind a bit)
- ⛔ Advanced usage
...
- ✅ Basic language knowledge, or code reading proficiency

- 💡 A device where you can type code (preferably a computer)
- 💡 A browser

- ⛔ Special software other than text editor (Notepad is fine)
- ⛔ Advanced gaming PC sultan spec
